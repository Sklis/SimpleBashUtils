...
"FLAGS for grep_fun.c s21_grep.c "
...
"-e intel  test_files/test_7_grep.txt"
"-e int test_files/test_7_grep.txt"
)
...
"-c -l int test_files/test_1_grep.txt test_files/test_5_grep.txt"
...
run_test() {
    ...
    "${sys_command[@]}" $param > "${s21_command[@]}".log
